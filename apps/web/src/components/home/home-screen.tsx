...
import { IconArrowRight, IconCirclePlus, IconLogin } from "@tabler/icons-react";
...
import { HomeFormCard, HomePanel } from "./home-panel.tsx";
...
export function HomeScreen() {
  ...
  return (
    <div className="home-shell relative flex min-h-dvh flex-col overflow-x-hidden xl:h-dvh xl:overflow-hidden">
      ...
      <main
        id="main"
        className="relative z-10 flex min-h-dvh flex-1 flex-col items-center justify-center overflow-x-hidden px-8 pt-24 pb-12"
      >
          ...
          <HomePanel>
            ...
            <div className="grid gap-6">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="w-24 shrink-0">
                        ...
                        <Input
                          ...
                          error={Boolean(
                            createForm.formState.errors.memberLimit,
                          )}
              ...
              <div className="flex items-center gap-4 px-4">
                ...
                <span className="font-label text-[10px] font-semibold tracking-[0.08em] text-ink-muted uppercase">
                  {t("home.or")}
                </span>
                <div className="h-px flex-1 bg-border" />
              </div>
